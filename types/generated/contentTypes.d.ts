...
export interface ApiDatiAssociazioneDatiAssociazione
  extends Struct.SingleTypeSchema {
  collectionName: 'dati_associaziones';
  info: {
    displayName: 'Dati Associazione';
    pluralName: 'dati-associaziones';
    singularName: 'dati-associazione';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroSection: Schema.Attribute.Component<'hero.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    nextEvent: Schema.Attribute.Component<'event.next-event', false>;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Component<'service.service', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSocialSocial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['facebook', 'instagram', 'linkedin', 'x', 'gmail']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSostieniciSostienici extends Struct.SingleTypeSchema {
  collectionName: 'sostienicis';
  info: {
    displayName: 'Sostienici';
    pluralName: 'sostienicis';
    singularName: 'sostienici';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiVolontariatoVolontariato extends Struct.SingleTypeSchema {
  collectionName: 'volontariatoes';
  info: {
    displayName: 'Volontariato';
    pluralName: 'volontariatoes';
    singularName: 'volontariato';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sostienici.sostienici': ApiSostieniciSostienici;
      'api::volontariato.volontariato': ApiVolontariatoVolontariato;
